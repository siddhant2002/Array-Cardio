const inventors = [
  ...
  // 4. Number of years lived by the inventors
  ...
  // Array.prototype.reduce()
  // 8. Finding the frequency of the elements
  const data = ['car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck', 'pogostick'];

  const package = data.reduce((obj, item) => {
    if(!obj[item])
    {
        obj[item]=0;
    }
